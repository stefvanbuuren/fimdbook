...
rm(list = ls())
project <- path.expand("~/Project/FIMD/FIMD2")
chapter <- file.path(project, "src")
source(file.path(project, "R/chapterinit.R"))
...
project <- path.expand("~/Project/FIMD/FIMD2")
source(file.path(project, "R/chapterinit.R"))
source(file.path(project, "R/mice.impute.x.R"))
library(mice, warn.conflicts = FALSE, quietly = TRUE)
...
project <- path.expand("~/Project/FIMD/FIMD2")
source(file.path(project, "R/chapterinit.R"))
source(file.path(project, "R/functions.R"))
library(mice, warn.conflicts = FALSE, quietly = TRUE)
...
source("~/Scripts/R/fetchandstore.r")
.store <- file.path(project, "Data/c85/R/store/")

dataproject <- file.path(project, "Data/c85")
# setwd(file.path(project,"R"))
# source(file.path(dataproject,"R/flux.r"))
# source(file.path(dataproject,"R/nelsonaalen.r"))
# source(file.path(project,"R/pool.r"))
# source(file.path(project,"R/with.mids.r"))
...
.store <- file.path(project, "Data/Daanen/R/store/")
fetch(nl)
selfreport <- nl
...
library(mice)
library(foreign)
dataproject <- file.path(project, "Data/wad")
# setwd(file.path(project,"R"))
source("~/Scripts/R/fetchandstore.r")
...
source(file.path(project, "R/chapterinit.R"))
source(file.path(project, "R/mice.impute.x.R"))
source(file.path(project, "R/fetchandstore.R"))
library(mice, warn.conflicts = FALSE, quietly = TRUE)
suppressPackageStartupMessages(library(gamlss, warn.conflicts = FALSE, quietly = TRUE))
...
library(haven)
library(mice)
dataproject <- file.path(project, "Data/pop")
source("~/Scripts/R/fetchandstore.r")
## source(file.path(project,"R/mice.r"))   ## temporary fix for augment
.store <- file.path(dataproject,"R/store/")
...
## ----vlginit, echo=FALSE-------------------------------------------------
dataproject <- file.path(project, "Data/vlg")
source("~/Scripts/R/fetchandstore.r")
.store <- file.path(dataproject,"R/store/")
...
## ----tbcinit, echo=FALSE-------------------------------------------------
dataproject <- file.path(project, "Data/tbc")
source("~/Scripts/R/fetchandstore.r")
.store <- file.path(dataproject,"R/store/")
...
## ----embed, echo=FALSE---------------------------------------------------
embedMyFonts <- function(project = path.expand("~/Project/FIMD/FIMD2"), 
                         figdir = "fig") {
  # specific for MacOS
