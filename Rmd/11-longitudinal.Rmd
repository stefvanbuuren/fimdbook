...
range of the measured ages, so $\kappa_1 \leq \min(t_i)$ and 
$\kappa_k \geq \max(t_i)$ for all $i$. It is convenient to set
$\kappa_1$ and $\kappa_k$ to rounded values just below and above the
minimum and maximum ages in the data, respectively. specified nine
...
accommodate for a pseudo time point with an exact age of 29years,
...
prematurely with a gestational age of 32weeks. This individual has an
