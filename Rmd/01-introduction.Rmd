...
time series of 153 days. It is well known that the standard error
associated with the ordinary least squares (OLS) estimate is too small 
if the residuals have positive serial correlations [@HARVEY1981]. The first
